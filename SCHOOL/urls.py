...
urlpatterns = [
	...
	url(r'^school/update/address/(?P<address_id>[0-9]+)/(?P<school_id>[0-9]+)/$', views.school_address_update, name="school_address_update"),
	...
	url(r'^class/student/register/(?P<student_id>[0-9]+)/(?P<user_id>[0-9]+)/$', views.classRegistration, name='register_class'),
	...
	url(r'^school/view/student/detail/(?P<student_id>[0-9]+)/$', views.profile_student_details, name="profile_student_details"),
	url(r'^school/view/parent/detail/(?P<parent_id>[0-9]+)/$', views.profile_parent_details, name="profile_parent_details"),
	
	url(r'^school/view/student/update/(?P<student_id>[0-9]+)/$', views.profile_student_update, name="profile_student_update"),
	url(r'^school/view/parent/update/(?P<parent_id>[0-9]+)/$', views.profile_parent_update, name="profile_parent_update"),
	url(r'^school/view/teacher/update/(?P<teacher_id>[0-9]+)/$', views.profile_teacher_update, name="profile_teacher_update"),
	url(r'^teacher/list/$', views.TeacherListView.as_view(), name='list_teacher'),
	
	url(r'^school/view/parent/update/address/(?P<parent_id>[0-9]+)/(?P<address_id>[0-9]+)$', views.profile_parent_address_update, name="profile_parent_address_update"),
	url(r'^school/view/student/update/address/(?P<student_id>[0-9]+)/(?P<address_id>[0-9]+)$', views.profile_student_address_update, name="profile_student_address_update"),
